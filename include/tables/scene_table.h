...
/* 0x64 */ DEFINE_SCENE(newscene_scene, none, SCENE_NEWSCENE, SDC_DEFAULT, 0, 0) // custom scene added for testing
/* 0x64 */ DEFINE_SCENE(minidungeon_scene, none, SCENE_MINIDUNGEON, SDC_DEFAULT, 0, 0) // custom minidungeon scene added for testing
#if DEBUG_ASSETS
